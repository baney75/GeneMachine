...
function detectOrientation(comments) {
  ...
  const lineEvidence = declarationLines.map((line) => ({
    line,
    forward: isCanonicalDeclaration(line, String.raw`forward|positive|plus`, "+"),
  ...
  const standaloneAmbiguity = /^(?:is\s+)?(?:not|unknown|ambiguous|undetermined|unspecified|uncertain|unconfirmed|possible|possibly|perhaps|maybe|likely|probably|tentative|provisional)(?:\s+(?:confirmed|known|declared|specified|verified))?[\s.!;:,-]*$/i;
