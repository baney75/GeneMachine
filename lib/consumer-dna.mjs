...
export function parseConsumerDna(text, fileName = "consumer-dna.txt", options = {}) {
  ...
  if (/[^\x09\x0A\x0D\x20-\x7E]/.test(normalizedText)) {
    throw new Error("This file contains non-ASCII or invisible Unicode formatting. Use the provider's original plain-text export without rich-text formatting.");
  }
