...
export function createDiscussionReportHtml({ report, finding, digest, isSynthetic }, options = {}) {
  ...
  :root{font-family:Inter,ui-sans-serif,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:#102035;background:#edf4f1}*{box-sizing:border-box}body{margin:0}main{width:min(820px,calc(100% - 36px));min-width:0;margin:32px auto;background:#fff;padding:clamp(24px,6vw,64px);box-shadow:0 14px 50px #17314920;overflow-wrap:anywhere}h1{font-size:2.7rem;line-height:1;margin:.2em 0}h2{font-size:1.2rem;margin-top:2rem}p,li{line-height:1.55}.kicker,.label{font-size:.72rem;letter-spacing:.12em;font-weight:800;color:#087967}.gate{border-left:5px solid ${finding.status === "supported_observation" ? "#14a389" : "#d9862f"};padding:16px 20px;background:#f2f8f6}.meta{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr);gap:1px;background:#d9e5e1;margin:24px 0;min-width:0}.meta div{background:#f7faf9;padding:14px;min-width:0;overflow-wrap:anywhere;word-break:break-word}.meta span{display:block;font-size:.7rem;color:#5b6f70}.warning{border:1px solid #d9862f;padding:18px;background:#fff9f0}.sources a{display:block;color:#0b5a72;margin:.5rem 0}@media(max-width:600px){.meta{grid-template-columns:minmax(0,1fr)}h1{font-size:2rem}}@media print{body{background:#fff}main{width:auto;margin:0;box-shadow:none;padding:0}.meta,.gate,.warning{break-inside:avoid}a{color:#102035}}
  ...
  <h2>Question for a clinician or pharmacist</h2><p>${escapeHtml(finding.clinicianDiscussion)}</p><div class="warning"><strong>Do not change treatment from this report.</strong> Consumer arrays are sparse genotyping, not sequencing or comprehensive clinical pharmacogenetic testing. Missing markers are unknown, not normal or reference calls.</div>
